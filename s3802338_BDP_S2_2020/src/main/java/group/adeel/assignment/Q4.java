...
public class Q4 {
	...
	public static class WordPartitioner extends Partitioner<Text, IntWritable> {
		...
		public int getPartition(Text key, IntWritable value, int numReduceTasks) {
			String wordSize = key.toString();

			// if word is small or medium process it on first reducer else second
			if (wordSize.equals("small") || wordSize.equals("medium"))
				return 0;
			else
